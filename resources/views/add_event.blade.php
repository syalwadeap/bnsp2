            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <div class="flex justify-center h-screen w-full">
                    <div class="bg-white rounded p-8 m-4">
                        <h1 class="block w-full text-center text-gray-800 text-2xl font-bold mb-6">Tambah event</h1>
                        <form action="/dashboard/create" method="post">
                            ...
                            <div class="flex flex-col mb-4">
                                ...
                                <input class="border py-2 px-3 text-grey-800" type="date" name="tanggal" id="tanggal">
                            </div>
                            <div class="flex flex-col mb-4">
                                <label class="mb-2 font-bold text-lg text-gray-900" for="informasi">Informasi</label>
                                <input class="border py-2 px-3 text-grey-800" type="text" name="informasi" id="informasi">
                            </div>
